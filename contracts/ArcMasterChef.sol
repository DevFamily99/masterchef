...
//** Author tj@depo.io : Arc Finance 2022.02 */
//** Author henry@depo.io : Arc Finance 2022.02 */
//** Version 2.0.0 */
...
contract ArcMasterChef is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function setTimeStamp(uint256 _pid, uint startingTime, uint closingTime) external  {
    
        UserInfo storage user = userInfo[_pid][msg.sender];
    require(user.startingTime == 0 && user.closingTime == 0, "Time has already been set");
    
        user.startingTime=startingTime;
